...
urlpatterns = [
    ...
    path('employment_profile/', user_views.lecturer_enrollment, name="employment_profile"),
    ...
    path('enroll/', user_views.student_enrollment, name='enroll_student'),

    path('lecturer-signup/', user_views.lecturer_enrollment, name='lecturer_signup'),


    # path('enroll/details/', user_views.enroll_student_details, name='enroll_student_details'),
    # Add a URL for a success page
    path('staff-signup/success/', user_views.lecturer_signup_success, name='lecturer_success'),
