...
from curriculum.models import Department, Session, Course, Programme, Level, Semester
...
class Examination(models.Model):
    ...
    semester = models.ForeignKey(Semester, on_delete=models.CASCADE, related_name='exams') # Link to Term  
...
class Quiz(models.Model):
    ...
    class Meta:
        ...
        verbose_name = "CBT Setting"
        verbose_name_plural = "CBT Settings"
